...
**178** files across **6** layers, **479** connections, **2** topic clusters.
...
- [eureka-005](learnings/staging/eureka-005.md) (staging)
...
- [know-040](learnings/staging/know-040.md) (staging)
...
### Cluster 2: docs + documents + convert
...
- **know-011** ↔ **know-012** — 9 shared: actionwriteback, back, connected-projects, e2e, flow
- **know-050** ↔ **know-049** — 9 shared: call, complex-key, context, curli, d2
- **know-031** ↔ **aha-005** — 9 shared: agent, approach, behavior, compound-learning, friction
- **know-031** ↔ **know-032** — 9 shared: approach, behavior, compound-learning, context, insights
- ... and 449 more connections
...
- [staging] **eureka-003** ↔ [skills] **ship** — automated, away, pipeline, prod
